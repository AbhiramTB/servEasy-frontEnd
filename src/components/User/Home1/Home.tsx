...
import LocationAutoSuggest from '../home/LocationSearchHome';
      ...
      <div className="relative w-full overflow-hidden rounded-lg bg-base h-96">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-4 bg-gradient-to-r from-base-300/80 to-primary/50">
          <div className="container flex flex-row items-center justify-between mx-auto">
            ...
            <div
              className={`transition-all duration-500 ease-in-out transform ${showSearchPanel ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-full pointer-events-none'}`}
            >
                ...
                <form onSubmit={handleSearchSubmit} className="space-y-4">
                  <div>
                    <div className="flex items-center mb-2">
                      ...
                      <label className="text-sm font-medium text-base-content">What service are you looking for?</label>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {searchTerm && (
                        <div className="gap-1 badge badge-secondary">
                          ...
                          <button onClick={clearSearch} className="ml-1 hover:text-secondary-content">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="w-3 h-3"
                              fill="none"
                      ...
                      {location && (
                        <div className="gap-1 badge badge-primary">
                          ...
                          <button onClick={clearLocation} className="ml-1 hover:text-primary-content">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="w-3 h-3"
                              fill="none"
      ...
      <div className="container px-4 py-16 mx-auto">
        <div className="flex flex-col gap-2 mb-8 sm:flex-row sm:items-center sm:justify-between">
            ...
            <h2 className="text-2xl font-bold text-base-content md:text-3xl">
              {searchTerm && location ? (
                <span className="flex items-center">
                  ...
                  <span>
                    "{searchTerm}" Services Near {location.address.split(',')[0]}
                  </span>
                </span>
              ) : searchTerm ? (
                <span className="flex items-center">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setShowSearchPanel(!showSearchPanel)} className="gap-2 btn btn-sm btn-secondary">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-4 h-4"
                fill="none"
            ...
            {(searchTerm || location) && (
              <button onClick={getAllServices} className="gap-2 btn btn-sm btn-outline btn-primary">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-4 h-4"
                  fill="none"
