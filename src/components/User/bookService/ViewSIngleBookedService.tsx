    ...
    <div className="container mx-auto bg-base-200 min-h-screen py-4 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <div className={`card bg-base-100 shadow-xl ${isCancelled ? 'border-error border' : isCompleted ? 'border-success border' : ''}`}>
            <div className="card-body">
              <div className="flex flex-col md:flex-row md:items-center mb-4 gap-4">
                ...
                <div className="flex-grow">
                  <h2 className="card-title text-primary">{service.serviceName}</h2>
                  <div className="flex items-center">
                    <span className="badge badge-outline badge-sm mr-2">{service.category}</span>
                    <span className="badge badge-outline badge-sm">{service.serviceType}</span>
                    {isCancelled && <span className="badge badge-error badge-sm ml-2">Cancelled</span>}
                    {isCompleted && <span className="badge badge-success badge-sm ml-2">Completed</span>}
                  </div>
                  <p className="text-base-content/70 mt-2 text-sm">{service.description}</p>
                  <div className="mt-3">
              ...
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-base-content/70">
                    <span className={`badge ${serviceProvider.isVerified === 'verified' ? 'badge-success' : 'badge-warning'} badge-sm mr-2`}>
              ...
              <div className="mt-6 mb-6">
                <h3 className="font-semibold mb-4 text-primary">Booking Status</h3>
                {isCancelled ? (
                  <div className="alert alert-error">
                    <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  ...
                  <ul className="steps steps-horizontal w-full">
                    ...
                    <li className={`step ${statusStep >= 3 ? 'step-primary' : ''}`}>In Progress</li>
              ...
              {isCancelled && (
                <div className="bg-error/10 p-4 rounded-lg mb-6">
                  <h3 className="font-semibold mb-2 text-error">Cancellation Details</h3>
                  <p className="text-sm">This service was cancelled on {new Date().toLocaleDateString('en-US', {
                    weekday: 'short',
                    month: 'short',
                    day: 'numeric'
                  })}.</p>
                  <p className="text-sm mt-2"><strong>Reason:</strong> Customer requested cancellation</p>
                  <p className="text-sm mt-2">
                    <strong>Refund Status:</strong> 
                    <span className="badge badge-outline badge-sm ml-2">Processing</span>
                  </p>
                </div>
              )}
              ...
              {isCompleted && (
                <div className="bg-success/10 p-4 rounded-lg mb-6">
                  <h3 className="font-semibold mb-2 text-success">Service Completion Details</h3>
                  <p className="text-sm">This service was completed on {new Date().toLocaleDateString('en-US', {
                    weekday: 'short',
                    month: 'short',
                    day: 'numeric'
                  })}.</p>
                  <div className="mt-4">
                    <h4 className="font-medium text-sm mb-2">Service Provider Notes:</h4>
                    <p className="text-sm italic bg-base-200 p-2 rounded">"Service completed successfully. Thank you for choosing our service!"</p>
                  </div>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                ...
                <div className="bg-base-200 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-primary">Booking Schedule</h3>
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <span>
                      {isCancelled 
                        ? <span className="line-through">{formattedEstimatedDate} at {formattedEstimatedTime}</span>
                ...
                <div className="bg-base-200 p-4 rounded-lg">
                  ...
                  <div className="flex items-center text-sm mb-2">
                    ...
                    <span>Status: 
                      <span className={`ml-2 badge ${
                        isCancelled 
                          ? 'badge-error' 
                          : bookedService.paymentStatus === 'completed' || isCompleted 
                            ? 'badge-success' 
                            : 'badge-warning'
                      } badge-sm`}>
                        {isCancelled ? 'Refunded' : isCompleted ? 'Paid' : bookedService.paymentStatus}
                      </span>
                    </span>
                  </div>
                  <div className="flex items-center text-sm">
                  ...
                  {isCancelled && (
                    <div className="mt-2 text-sm bg-base-100 p-2 rounded border border-error/20">
                      <p className="font-medium text-error">Refund Information</p>
                      <p className="mt-1">Refund initiated: {new Date().toLocaleDateString()}</p>
              ...
              <div className="card-actions justify-end mt-8">
                ...
                {isCancelled && (
                  <button className="btn btn-outline">View Cancellation Policy</button>
                )}
                {isCompleted && (
        ...
        <div className="md:col-span-1">
            ...
            <div className="card-body">
              <div className="flex justify-between items-center mb-4">
                ...
                {!isCancelled && !isCompleted && (
                  <button className="btn btn-sm btn-ghost text-primary">Change</button>
                )}
              </div>
              <div className="text-sm">
                <p className="font-medium">{bookedService.address.name}</p>
                <p>{bookedService.address.houseName}</p>
                <p>{bookedService.address.state} - {bookedService.address.pincode}</p>
                ...
                {!isCancelled && !isCompleted && (
                  <div className="mt-2">
                    <button className="btn btn-sm btn-outline btn-primary">Change or Add number</button>
                  </div>
                )}
              </div>
            </div>
          ...
          {isCompleted && (
            <div className="card bg-base-100 shadow-xl mt-6">
              <div className="card-body">
                <h3 className="font-semibold mb-4 text-primary">Rate your experience</h3>
                ...
                <textarea className="textarea textarea-bordered w-full mb-2" placeholder="Share your experience (optional)"></textarea>
          ...
          {!isCompleted && (
            <div className="card bg-base-100 shadow-xl mt-6">
              <div className="card-body">
                <h3 className="font-semibold mb-2 text-primary">More options</h3>
