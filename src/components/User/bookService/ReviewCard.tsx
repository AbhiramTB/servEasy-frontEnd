...
const ReviewCard: React.FC<IReviewCardProp> = ({
  bookedServiceId,
  serviceId,
  review
}) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (res.status === 201) {
        HotToastSuccess(
          "Thanks for your feedback! Your rating was submitted successfully"
        );
        setSubmitted(true);
        setShowForm(false);
      }
    ...
    <div className="mt-6 shadow-xl card bg-base-100">
      ...
      <div className="card-body">
        ...
        {!review && !submitted && !showForm && (
          <button
            className="mt-4 btn btn-outline btn-primary btn-block"
