      ...
      <div className="shadow-lg navbar bg-primary">
        <div className="navbar-start">
          ...
          <div className="lg:hidden">
            <button className="btn btn-ghost text-primary-content" onClick={toggleMenu}>
          ...
          <a className="font-serif text-xl btn btn-ghost text-primary-content">ServEasy</a>
        </div>
        ...
        <div className="hidden navbar-center text-primary-content lg:flex">
          <ul className="px-1 menu menu-horizontal">
            ...
            <li><p className="font-medium">Service Management</p></li>
            </Link>
      ...
      {isMenuOpen && (
        <div className="shadow-lg lg:hidden bg-primary">
          <ul className="w-full px-4 py-2 menu menu-vertical text-primary-content">
            <li><a className="py-2 font-medium">Home</a></li>
            <li className="py-2">
              <details>
                <summary className="font-medium">Services</summary>
                <ul className="p-2 mt-2 rounded bg-base-100">
                  <li><a className="py-2">Add New Services</a></li>
                  <li><a className="py-2">Edit Services</a></li>
                  <li><a className="py-2">Enable/Disable</a></li>
                </ul>
              </details>
            </li>
            <li><a className="py-2 font-medium">Service Management</a></li>
            <li><a className="py-2 font-medium">Booking</a></li>
            <li><a className="py-2 font-medium">Contact</a></li>
          </ul>
        </div>
      )}
    </div>
