...
const PaymentModal: React.FC<IProps> = ({ payment, setPayment, closeModal, makePaymentRequest }) => {
  useEffect(() => {
    const total =
  ...
  }, [payment.serviceCost, payment.materialCost, payment.travelCost, payment.inspectionCost]);
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-4">
              <div className="form-control">
                <label htmlFor="serviceCost" className="label">
                  <span className="text-base font-medium label-text">Service Cost</span>
                </label>
                <input
                  type="number"
                  id="serviceCost"
              ...
              <div className="form-control">
                <label htmlFor="materialCost" className="label">
                  <span className="text-base font-medium label-text">Material Cost</span>
                </label>
                <input
                  type="number"
                  id="materialCost"
              ...
              <div className="form-control">
                <label htmlFor="travelCost" className="label">
                  <span className="text-base font-medium label-text">Travel Cost</span>
                </label>
                <input
                  type="number"
                  id="travelCost"
              ...
              <div className="form-control">
                <label htmlFor="inspectionCost" className="label">
                  <span className="text-base font-medium label-text">Inspection Cost</span>
                </label>
                <input
                  type="number"
                  id="inspectionCost"
          ...
          <div className="card ">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-extrabold">₹{payment.total.toFixed(2)}</span>
            </div>
          </div>
