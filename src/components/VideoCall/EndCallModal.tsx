          ...
          <div className="space-y-6 text-center">
            ...
            {!isHangUp && (
              <div className="space-y-3">
                <h3 className="text-2xl font-bold text-white">Call Rejected</h3>
                <p className="text-lg text-gray-300">by {userName || 'opponent'}</p>
              </div>
            )}

            {isHangUp && <p className="leading-relaxed text-red-400">The other user has hung up the call</p>}

            {!isHangUp && <p className="leading-relaxed text-gray-400">The service provider declined your call.</p>}
