...
//   { to: ROUTES.ADMIN.COUPON_MANAGEMENT, icon: Receipt, label: 'Coupon Management' },
...
export const adminLinks = [
  ...
  { to: ROUTES.ADMIN.SERVICE_PROVIDER_LISTING, icon: Briefcase, label: 'Providers' },
  {
    to: ROUTES.ADMIN.SERVICE_PROVIDER_VERIFICATION,
    icon: BadgeCheck,
  ...
  {
    to: ROUTES.ADMIN.subscriptionManagement,
    icon: CalendarCog,
  ...
  {
    to: ROUTES.ADMIN.SERVICE_PROVIDER_WALLETS,
    icon: Wallet,
